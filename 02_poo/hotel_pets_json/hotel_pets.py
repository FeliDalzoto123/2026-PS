...
class Pet:
    def __init__(self, nome, especie, dataNasc, idade, peso, altura, nome_dono, vacinado, hospedado=False):
        self.nome = nome
...
def cadastrar_pet(lista_pets):
    ...
    pet = Pet(nome, especie, dataNasc, idade, peso, altura, nome_dono, vacinado)
    lista_pets.append(pet)
